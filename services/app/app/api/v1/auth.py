...
def register():
    ...
    try:
        ...
        db.session.rollback()
        return rest_api_response(
            success=False, message="Registration failed", status_code=500, exc=e
        )
...
def login():
    ...
    try:
        ...
        return rest_api_response(
            success=False, message="Login failed", status_code=500, exc=e
        )
...
def refresh():
    try:
        ...
        return rest_api_response(
            success=False, message="Token refresh failed", status_code=500, exc=e
        )
